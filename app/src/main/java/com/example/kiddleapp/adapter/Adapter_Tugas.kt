...
class Adapter_Tugas(private var data:List<Model_Tugas>, private val listener: (Model_Tugas) -> Unit):RecyclerView.Adapter<Adapter_Tugas.ViewHolder>()  {
    ...
    class ViewHolder(view: View):RecyclerView.ViewHolder(view) {
        ...
        fun bindItem(data:Model_Tugas, listener: (Model_Tugas) -> Unit, context: Context, position: Int) {
